      ...
      <main>
        <div className={container.pageContainer}>
          ...
          <Collapse heading="Volksinitiative «Ja zum Tier und Menschenversuchsverbot»">
            ...
            <LinkBlock link={ new URL("https://www.admin.ch/gov/de/start/dokumentation/abstimmungen/20220213/volksinitiative-ja-zum-tier-und-menschenversuchsverbot.html") }>
              Mehr Informationen (admin.ch)
            </LinkBlock>
          </Collapse>
          <Link href="./volksinitiative-ja-zum-tier-und-menschenversuchsverbot/listen">
            <div className={ button.primaryForward }>
              <span>
